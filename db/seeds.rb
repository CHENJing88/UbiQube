...
Vm.create(nom:"Preprod",ip_defaut:180552305,template:"Windows7",etat_app_id:e1.id)
Vm.create(nom:"Prod",ip_defaut:180552305,template:"Sabayon",etat_app_id:e1.id)
