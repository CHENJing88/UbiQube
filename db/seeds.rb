...
App.create(nom:"lifray", niveau:"font", etat_app_id:e1.id, etape_id:ep1.id, groupe_app_id: gp1.id)
App.create(nom:"SSH", niveau:"mid", etat_app_id:e3.id, etape_id:ep2.id, groupe_app_id: gp1.id)
